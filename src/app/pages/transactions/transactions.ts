  ...
  loadCharts(){
    ...
    .subscribe({
      ...
      next:(data)=>{
        ...
        this.barTooltipFormatter =
        (val:number)=>{

          return `${val.toLocaleString()} IRR`;
    ...
    .subscribe({
      ...
      next:(res)=>{
        ...
        if(res){
          ...
          this.totalExpense =
          res.grand_total_expense;


          this.totalDeposit =
          res.grand_total_deposit;
